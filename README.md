...
最新交接见 [2026-09-10 handoff](docs/HANDOFF_2026-09-10.md)：第一幕探索收尾已接入，下一步是冰箱探索与第二幕小呆猪黑暗森林。

最新设定与美术重制方向见 [方向文档](docs/STORY_AND_ART_DIRECTION.md)，协作约定见 [AGENTS.md](AGENTS.md)，进度见 [WORKLOG.md](WORKLOG.md)。序章为约 89 秒的手绘分镜版；第一幕已接入三间手绘房间，离家后切到呆呆猪的旧森林样板。没有终极 Boss 战；最终巫师死于白菜认出呆呆猪时爆发的快乐能量。
