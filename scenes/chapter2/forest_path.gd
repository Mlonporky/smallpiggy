...
func _ready() -> void:
	...
	player.armed = true
	# The upper artwork depicts the cave interior/wall, not a walkable hill.
	# End the floor at the lit apron (y=245); E transitions from in front of it.
	wall(PackedVector2Array([Vector2(0,0),Vector2(1448,0),Vector2(1448,245),Vector2(1060,245),Vector2(975,280),Vector2(825,335),Vector2(655,470),Vector2(555,650),Vector2(490,850),Vector2(450,1086),Vector2(0,1086)]))
	wall(PackedVector2Array([Vector2(1448,245),Vector2(1210,245),Vector2(1250,265),Vector2(1130,390),Vector2(1030,470),Vector2(915,650),Vector2(910,820),Vector2(1010,1086),Vector2(1448,1086)]))
	rectangle(Rect2(0,1040,1448,46))
	discovered = GameState.has_flag("s2_cave_discovered")
	cave_door = hotspot(Vector2(1130,290), "进入发光的山洞", enter_cave)
